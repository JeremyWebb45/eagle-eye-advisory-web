...
db_user = env_values['POSTGRES_USER']
db_password = env_values['POSTGRES_PASSWORD']
db_host = env_values['POSTGRES_HOST']
db_port = env_values['POSTGRES_PORT']
db_name = env_values['POSTGRES_DB']

print(f"DEBUG: DB Credentials - User: {db_user}, Host: {db_host}, Port: {db_port}, DB: {db_name}")
